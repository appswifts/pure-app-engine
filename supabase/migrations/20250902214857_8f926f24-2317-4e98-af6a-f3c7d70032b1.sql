-- Fix subscription plans table and create comprehensive manual payment system

-- Drop and recreate subscription_plans with proper structure
DROP TABLE IF EXISTS subscription_plans CASCADE;
CREATE TABLE subscription_plans (
    id TEXT PRIMARY KEY, -- Use text IDs for easy reference
    name TEXT NOT NULL,
    description TEXT,
...
-- Create subscriptions table (enhanced for manual payments)
...
CREATE TABLE manual_payment_instructions (
    ...
    account_number TEXT,
    account_name TEXT,
    mobile_money_numbers JSONB DEFAULT '[]'::jsonb,
...
-- Insert default subscription plans with text IDs
